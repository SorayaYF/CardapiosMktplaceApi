...
public class RestauranteServiceImpl implements RestauranteService {
	...
	public Restaurante salvar(Restaurante restaurante) {
		...
		if(outroRestaurante != null) {
			if(outroRestaurante.isPersistido()) {
				Preconditions.checkArgument(outroRestaurante.equals(restaurante),"O nome da restaurante já está em uso");
			}
		}
	...
	public void atualizarStatusPor(Integer id, Status status) {
		...
		Preconditions.checkNotNull(restauranteEncontrado, "Não existe restaurante vinculado ao id informado");
